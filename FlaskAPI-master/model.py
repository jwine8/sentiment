...
# Loading Data
#data = pd.read_csv('https://raw.githubusercontent.com/dseneh/FlaskAPP/master/google-2015-2019.csv', parse_dates=['Date'])
data = pd.read_csv('', parse_dates=['Date'])
...
## Save the Model
pickle.dump(model_fit, open('model_predict.plk', 'wb'), protocol=2)
